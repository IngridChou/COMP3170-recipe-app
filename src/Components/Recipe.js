    ...
    <Card maxW="sm">
      <CardBody>
        ...
        <Stack mt="6" spacing="3">
          ...
          <Text>
            <span style={{ textDecoration: "underline" }}> Dish type</span><span>: </span>
            {Array.isArray(recipe.dishTypes) && recipe.dishTypes.length > 0
              ? recipe.dishTypes.join(", ")
              : "N/A"}
          </Text>
          <Text>
            <span style={{ textDecoration: "underline" }}> Cuisine</span><span>: </span>
            {Array.isArray(recipe.cuisines) && recipe.cuisines.length > 0
              ? recipe.cuisines.join(", ")
              : "N/A"}
          </Text>
          <Text>
            <span style={{ textDecoration: "underline" }}>Servings</span><span>: </span> {recipe.servings || "N/A"}
          </Text>
          <Text>
            <span style={{ textDecoration: "underline" }}>Ready in</span><span>: </span> {recipe.readyInMinutes || "N/A"} minutes
          </Text>
